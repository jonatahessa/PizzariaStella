...
public class Utils {
    ...
    public static List<Produto> ListarPizzasPaginaInicialFogazzas() throws Exception {
        List<Produto> pizzas = new ArrayList<>();
        pizzas = br.com.pizzariadomenico.Daos.DaoProduto.listarPaginaInicialFogazzas();
